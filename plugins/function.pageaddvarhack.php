 ...
 * @return string
 */
function smarty_function_pageaddvarhack($params, Zikula_View $view)
{
    ...
    if (in_array($name, array('stylesheet', 'javascript'))) {
        $value = explode(';', $value); // hack is to change , to ; so that commas that are part of url syntax is preserved.
    }
